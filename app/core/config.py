...
REFRESH_TOKEN_EXPIRE_MINUTES = int(os.environ.get("JWT_REFRESH_TOKEN_EXPIRE_MINUTES"))
VERIFY_TOKEN_SECRET_KEY = str(os.environ.get("JWT_VERIFY_TOKEN_SECRET_KEY"))
VERIFY_TOKEN_EXPIRE_MINUTES = int(os.environ.get("JWT_VERIFY_TOKEN_EXPIRE_MINUTES"))
