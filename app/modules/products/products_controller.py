...
@router.get('/')
async def get_all_product(page: int = None, quantity: int = None, category_uuid: str = None):
    return client.get(path='/product', params={ "page": page, "quantity": quantity, "category_uuid": category_uuid})
